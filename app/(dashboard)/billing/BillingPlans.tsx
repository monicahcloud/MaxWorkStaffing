...
const features = [
  ...
  },
  {
    ...
    subtext:
      "Practice with our AI and get instant feedback on your performance",
  },
];
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto space-y-6 mt-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-4 shadow-md relative bg-white">
              ...
              <ul className="text-sm text-gray-700 ">
                ...
                <li className="flex items-center gap-2">
                  <Check className="w-5 h-5 text-red-500" />
                  <span>
                    <strong>1 AI Mock Interview</strong> session.
                  </span>
                </li>
              </ul>
          ...
          <div
            ...
            <ul className="text-sm text-gray-700  pl-5 space-y-2">
              ...
              <li className="flex items-center gap-2">
                <Check className="w-5 h-5 text-red-500" />
                <span>
                  <strong>20 AI Mock Interview</strong> sessions per month.
                </span>
              </li>
            </ul>
          ...
          {/* Quarterly Plan */}
          <div
            className={`border-2 border-blue-600 rounded-lg p-4 shadow-xl bg-white relative ...`}>
            <div className="absolute top-[-10px] left-1/2 -translate-x-1/2 bg-blue-600 text-white px-4 py-1 text-xs font-black rounded-full">
              BEST VALUE
            </div>{" "}
