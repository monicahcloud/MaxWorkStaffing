...
function CoverLetterPersonalInfoForm({
  coverLetterData,
  setCoverLetterData,
  ...
  const form = useForm<UserInfoValues>({
    ...
    defaultValues: {
      ...
      userPhone: coverLetterData.userPhone || "",
  ...
  useEffect(() => {
    const debouncedUpdate = debounce((values: UserInfoValues) => {
  ...
  return (
    <div className=" personal-info max-w-xl mx-auto space-y-6">
      ...
      <Form {...form}>
        <form>
          {coverLetterData.template !== "Todah" && (
            <FormField
...
export default CoverLetterPersonalInfoForm;
