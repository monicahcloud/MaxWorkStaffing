...
function StatsContainer() {
  ...
  return (
    <div className="grid md:grid-cols-2 gap-4 lg:grid-cols-3">
      ...
      <StatsCard title="pending jobs" value={data?.Hired || 0} />
      <StatsCard title="interviews set" value={data?.Offered || 0} />
      <StatsCard title="jobs declined" value={data?.Submitted || 0} />
    </div>
  );
}
